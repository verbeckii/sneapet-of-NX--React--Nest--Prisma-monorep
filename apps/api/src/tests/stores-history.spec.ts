...
const resp1 = [
  ...
  },
  {
    ...
    TimeSlot: '2022-04-13:11',
    label: '13:46',
    minute: '2022-04-13 14:46:00',
    time: 1649846760000,
  },
];

describe('store-history-Controller (e2e)', () => {
  let db: Db;
  let collectionTimings;
  let collectionTotalsAttendance;
  ...
  beforeEach(async () => {
    ...
    await db.createCollection(Collections.totalattendance);
    collectionTotalsAttendance = db.collection(Collections.totalattendance);
    apiKeyStrategy =
  ...
  it('test3 totalAttendance', async () => {
    const apiKey = 'abda4a94-95d3-47a5-889f-03b9f96fd084';
    collectionTimings.insertMany([doc1, doc2, doc4, doc5]);
    collectionTotalsAttendance.insertMany([doc7, doc8, doc9, doc10]);
    await prismaHelpers.addDbApiKey({
      customerCode,
      userCode,
      apiKey,
    ...
    await prismaHelpers.prismaAddAttendanceAlarmActive(1);
    await prismaHelpers.prismaAddArea('areaCode', 1);
    await prismaHelpers.prismaAddDevice(
      'testdevicecode',
      '3D',
